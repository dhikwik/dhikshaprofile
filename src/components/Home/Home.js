    ...
    return(
        <div>
            ...
            <div className="container">
                <h1 className="text-center fw-bold" data-testid="main-page-title-text">Hey Champs, Whats on your mind. Are you up for some interesting things</h1>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <Link to="/newsFeed"><button type="button" className="btn btn-primary">View More</button></Link>
                        </div>
                    </div>    
                    <div className="col-md-6">
